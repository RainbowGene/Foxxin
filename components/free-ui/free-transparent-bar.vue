<template>
	<view>
		<view class="fixed-top" :style="navBarStyle">
			...
			<!-- 导航 -->
			<view class="w-100 flex-row align-center justify-between" style="height: 90rpx;">
				<!-- 左边 -->
				<view class="flex-row align-center">
					<!-- 返回按钮 -->
					<view class="flex-row align-center justify-center" hover-class="bg-hover-light" @click="back" style="height: 90rpx;width: 90rpx;">
				...
				<!-- 右边 -->
				<view class="flex-row align-center">
					<view class="flex-row align-center justify-center" hover-class="bg-hover-light" style="height: 90rpx;width: 90rpx;"
