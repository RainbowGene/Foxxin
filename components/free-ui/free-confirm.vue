<template>
	<free-popup ref="confirm" center maskColor transformOrigin="center center">
		<view class="bg-white rounded" style="width: 600rpx;">
			...
			<!-- 底部 -->
			<view style="height: 100rpx;" class="border-top flex-row align-stretch">
				<view class="flex-1 border-right flex-row align-center justify-center" @click="cancel">
					<text class="font-md text-muted">取消</text>
				</view>
				<view class="flex-1 flex-row align-center justify-center" @click="confirm">
